...
def main():
    print(Fore.GREEN + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTGREEN_EX + 'Lorem' + Fore.RESET)

    print(Fore.CYAN + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTCYAN_EX + 'Lorem' + Fore.RESET)

    print(Fore.BLUE + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTBLUE_EX + 'Lorem' + Fore.RESET)

    print(Fore.MAGENTA + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTMAGENTA_EX + 'Lorem' + Fore.RESET)

    print(Fore.RED + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTRED_EX + 'Lorem' + Fore.RESET)

    print(Fore.YELLOW + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTYELLOW_EX + 'Lorem' + Fore.RESET)

    print(Fore.WHITE + 'Lorem' + Fore.RESET)
    print(Fore.LIGHTWHITE_EX + 'Lorem' + Fore.RESET)
    pass
